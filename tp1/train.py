...
trainset = datasets.CIFAR10(root='./data2', train=True, download=False, transform=transform)
testset  = datasets.CIFAR10(root='./data2', train=False, download=False, transform=transform)
